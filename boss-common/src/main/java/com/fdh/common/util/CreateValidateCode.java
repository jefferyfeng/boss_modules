...
public class CreateValidateCode {
	...
	private void createImage() {
		...
		Font font = new Font(fontDefault, Font.BOLD, fontHeight);
		g.setFont(font);
		...
		// 添加噪点
		// 噪声率
		float noisyPointRate = 0.01f;
		int area = (int) (noisyPointRate * width * height);
		...
		// 得到随机字符
		String str1 = CodeUtil.buildCode(codeCount);
		this.code = str1;
