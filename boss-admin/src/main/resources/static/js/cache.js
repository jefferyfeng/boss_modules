...
var uname = document.getElementsByClassName('adminName')[0].innerHTML;
...
layui.use(['form','jquery',"layer"],function() {
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        ...
        $("#userFace").attr("src",contextPath + "/static/images/photo.jpg");
    }
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['我已了解'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">Boss后台管理系统</span></p></div>',
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="'+contextPath+'/static/images/face.jpg" class="userAvatar"/></div>'+
