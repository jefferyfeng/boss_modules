...
<div class="main markdown">
    ...
    <script type="text/javascript" src="${request.getContextPath()}/larry/common/frame/layui/layui.js" charset="utf-8"></script>
    <script type="text/javascript" src="${request.getContextPath()}/larry/common/css/font/iconfont.js"></script>
    <script type="text/javascript" src="${request.getContextPath()}/larry/backstage/js/common.js"></script>
    <script type="text/javascript" src="${request.getContextPath()}/larry/backstage/js/font.js"></script>
</body>
</html>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${request.getContextPath()}/larry/common/css/gobal.css" media="all">
    <link rel="stylesheet" href="${request.getContextPath()}/larry/common/css/fontutil.css">
</head>
<body>
<div class="larry-box">
    <blockquote class="layui-elem-quote">
